...
class Captcha
{
    ...
    protected function configure(array $config = []): void
    {
        ...
        $config = empty($config) ? $captcha : array_merge($captcha, $config);
     ...
     * @throws Exception
     */
    public function create(array $config = []): Response
    {
        ...
        // 图片宽(px)
        $this->imageW || $this->imageW = $this->length * $this->fontSize * 1.3 + $this->length * $this->fontSize / 2;
        // 图片高(px)
